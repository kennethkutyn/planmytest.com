import { actionWithDelay } from '@amplitude/rrweb-types';
import { addedNodeMutation } from '@amplitude/rrweb-types';
import { blockClass } from '@amplitude/rrweb-types';
import { canvasMutationData } from '@amplitude/rrweb-types';
import { DataURLOptions } from '@amplitude/rrweb-types';
import { DeprecatedMirror } from '@amplitude/rrweb-types';
import { DocumentDimension } from '@amplitude/rrweb-types';
import { Emitter } from '@amplitude/rrweb-types';
import { EventType } from '@amplitude/rrweb-types';
import { eventWithTime } from '@amplitude/rrweb-types';
import { Handler } from '@amplitude/rrweb-types';
import { hookResetter } from '@amplitude/rrweb-types';
import { hooksParam } from '@amplitude/rrweb-types';
import { IMirror } from '@amplitude/rrweb-types';
import { IncrementalSource } from '@amplitude/rrweb-types';
import { IWindow } from '@amplitude/rrweb-types';
import { KeepIframeSrcFn } from '@amplitude/rrweb-types';
import { listenerHandler } from '@amplitude/rrweb-types';
import { MaskInputFn } from '@amplitude/rrweb-snapshot';
import { MaskInputOptions } from '@amplitude/rrweb-snapshot';
import { maskTextClass } from '@amplitude/rrweb-types';
import { MaskTextFn } from '@amplitude/rrweb-snapshot';
import { Mirror } from '@amplitude/rrweb-snapshot';
import { MouseInteractions } from '@amplitude/rrweb-types';
import { PackFn } from '@amplitude/rrweb-types';
import { playerMetaData } from '@amplitude/rrweb-types';
import { RecordPlugin } from '@amplitude/rrweb-types';
import { ReplayerEvents } from '@amplitude/rrweb-types';
import { RRDocument } from '@amplitude/rrdom';
import { RRIFrameElement } from '@amplitude/rrdom';
import { RRNode } from '@amplitude/rrdom';
import { SamplingStrategy } from '@amplitude/rrweb-types';
import { SlimDOMOptions } from '@amplitude/rrweb-snapshot';
import { StateMachine } from '@xstate/fsm';
import { textMutation } from '@amplitude/rrweb-types';
import { throttleOptions } from '@amplitude/rrweb-types';
import { UnpackFn } from '@amplitude/rrweb-types';
...
export declare class Replayer {
    ...
    private isShadowRoot;
    private insertStyleRulesIntoShadowRoot;
...
export declare namespace record {
    ...
    var freezePage: () => void;
    var takeFullSnapshot: (isCheckout?: boolean | undefined) => void;
    var mirror: import("@amplitude/rrweb-snapshot").Mirror;
}
