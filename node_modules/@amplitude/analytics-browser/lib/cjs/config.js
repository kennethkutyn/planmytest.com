...
exports.getTopLevelDomain = exports.createTransport = exports.createCookieStorage = exports.useBrowserConfig = exports.BrowserConfig = void 0;
...
var createCookieStorage = function (identityStorage, cookieOptions) {
    ...
    switch (identityStorage) {
        ...
        case 'cookie':
        default:
            return new analytics_core_1.CookieStorage(tslib_1.__assign(tslib_1.__assign({}, cookieOptions), { expirationDays: cookieOptions.expiration }));
    }
};
...
var createTransport = function (transport) {
    ...
    return new analytics_core_1.FetchTransport();
};
